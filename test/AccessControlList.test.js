...
describe('access control list', function() {
  ...
  it('hard ACL set to true - authorized', function (done) {
    ...
    assert.ok(acl.shouldApply(obj, 'list').ok)

    acl.authorize(obj, 'list', ['EMEA'], {}, function(err, result) {
  ...
  it('hard ACL set to true - denied', function (done) {
    ...
    acl.authorize(obj, 'list', ['role'], {}, function(err, result) {
  ...
  it('hard ACL set to false - authorized', function (done) {
  ...
  it('hard ACL set to false - denied', function (done) {
